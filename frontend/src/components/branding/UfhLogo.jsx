  ...
  return (
    ...
    >
      <img
        ...
        referrerPolicy="no-referrer"
      />
      <span className="-mt-[18%] pb-[17%] font-serif text-[clamp(20px,8vw,34px)] font-semibold leading-none tracking-[-0.03em] text-zinc-950">
        University of Fort Hare
      </span>
      <span className="-mt-[13%] pb-[10%] font-serif text-[clamp(13px,4.5vw,20px)] italic leading-none text-zinc-950">
